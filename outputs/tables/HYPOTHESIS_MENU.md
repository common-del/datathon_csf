...
**EH8. Where girls are over-assessed relative to boys, the girls' score lead is larger (participation, not learning)**
- effect: r=0.47 (p=1.14e-05, n=80 district-years) between (girls-boys coverage) and (girls-boys score)
- evidence: all three years pooled
- caveat: district-level; within-school selection unobserved
- policy: If near zero, the girls' lead looks like learning, not who showed up.
...
- effect: Udupi pooled rank 1 of 29 on 17.7% coverage; Dakshina Kannada pooled rank 2 of 29 on 6.2% coverage; Uttara Kannada pooled rank 3 of 29 on 2.3% coverage; and Udupi, Uttara Kannada, Dakshina Kannada absent from the 2024-25 round entirely
